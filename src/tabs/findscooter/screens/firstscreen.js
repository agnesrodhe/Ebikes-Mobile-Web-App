...
return (
    <div className='findscooter-container'>
      ...
      <div className='findscooter-index-buttons-container'>
        ...
        <button onClick={() => {goToMap("Visby", {lat: 57.629472, lng: 18.309996})}} className='main-button'>
          <h4>Visby</h4>
        </button>

        <button onClick={() => {goToMap("Västerås", {lat: 59.611060, lng: 16.544369})}} className='main-button'>
          <h4>Västerås</h4>
        </button>

        <button onClick={() => {goToMap("Lund", {lat: 55.703571, lng: 13.191943})}} className='main-button'>
          <h4>Lund</h4>
        </button>
